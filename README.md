...
<p align="center">
    <img width="957" src="https://user-images.githubusercontent.com/71639489/215088694-dad63d41-0676-4b45-b123-ba3496422b75.png">
</p>
<p align="center">
...
And to classify a new image using a trained neural network, the classifyer::classify(std::vector<int>::iterator immage) is used.
    ...
    cl.classify(std::vector<int>::iterator immage);
...
You can also find an example of using the framework [here](https://github.com/ft-290008buchok/Letter_classifier).
